var tableHtmlCollection = document.querySelectorAll('form table');
for(var index=0; index<tableHtmlCollection.length; index++){
    var tableNode = tableHtmlCollection.item(index);
    var inputNodeList = tableNode.querySelectorAll('input,textarea');
    ...
    inputNodeList.forEach((inputNode, i)=>{
        ...
        currentDiv.classList.add('form-floating', 'my-1');
